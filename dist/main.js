...
function createTaskEl(newTask) { 
    ...
    if (newTask.dueDate) {
        const dueDateContainer = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'due-date-container', taskOptionContainer);

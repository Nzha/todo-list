...
function loadEmptyState() {
    ...
    const emptyStateContainer = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'empty-state-container', contentContainer);
    const emptyStateImg = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'empty-state-img', emptyStateContainer);
    const emptyStateHeader = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('h3', 'empty-state-header', emptyStateContainer);
    const emptyStateTxt = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'empty-state-txt', emptyStateContainer);
...
function getProjects(...names) {
    for (const name of names) {
        let id = (0,_functions__WEBPACK_IMPORTED_MODULE_0__.increment)();

        // Prevent identical IDs
        myProjects.forEach(myProject => {if (myProject.id == id) id = (0,_functions__WEBPACK_IMPORTED_MODULE_0__.increment)()});
...
function createProjectEl(project, container, parentEl) {
    ...
    // OPTIONS
    const projectOptionContainer = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'sidebar-projects-options', projectDiv);
    const optionsBtn = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'sidebar-projects-options-btn', projectOptionContainer);
...
function createOptionMenuEl(e) {
    const projectsItem = e.target.closest('.sidebar-projects-item');
    const dropdownMenu = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'dropdown-menu', projectsItem);
    const dropdownEdit = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'dropdown-menu-edit', dropdownMenu);
    const dropdownDelete = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'dropdown-menu-delete', dropdownMenu);
...
function createProjectForm(container, parentEl) {
    ...
    const btnContainer = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'form-project-btn-container', projectForm);
...
function updateTaskCount() {
    ...
    const storedTasks = JSON.parse(localStorage.getItem('tasks'));
    const todaysTasks = storedTasks.filter(task => (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.dueDate)));
    const thisWeekTasks = storedTasks.filter(task => (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.dueDate)));

    if (!allTasksCount) {
        const allTasksCount = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'sidebar-tasks-item-count', allTasksLink);
        const todaysTasksCount = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'sidebar-tasks-item-count', todayTasksLink);
        const thisWeekTasksCount = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'sidebar-tasks-item-count', weekTasksLink);
...
function loadTaskForm(container, parentEl) {
    ...
    const taskForm = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('form', 'task-form', parentEl);
    const taskEditor = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'task-form-editor', taskForm);
    const newTaskFormContainer = taskForm.closest('.new-task-form-container');

    const taskName = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('input', 'taskName', taskEditor);
    ...
    const taskDescription = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('textarea', 'taskDescription', taskEditor);
    ...
    const taskDueDate = (0,_functions__WEBPACK_IMPORTED_MODULE_0__["default"])('input', 'taskDueDate', taskEditor);
